...
bool EqEngineManager::usesCentralEqualityEngine(const Options& opts,
                                                TheoryId id)
{
...
EqEngineManager::CentralNotifyClass::CentralNotifyClass(EqEngineManager& eem)
    : d_eem(eem), d_mNotify(nullptr), d_quantEngine(nullptr)
{
}
    ...
    TNode predicate, bool value)
{
  Trace("eem-central") << "eqNotifyTriggerPredicate: " << predicate
                       << std::endl;
  return d_eem.eqNotifyTriggerPredicate(predicate, value);
}
    ...
    TheoryId tag, TNode t1, TNode t2, bool value)
{
  ...
  return d_eem.eqNotifyTriggerTermEquality(tag, t1, t2, value);
}

void EqEngineManager::CentralNotifyClass::eqNotifyConstantTermMerge(TNode t1,
                                                                    TNode t2)
{
  Trace("eem-central") << "eqNotifyConstantTermMerge: " << t1 << " " << t2
                       << std::endl;
  d_eem.eqNotifyConstantTermMerge(t1, t2);
}
...
void EqEngineManager::CentralNotifyClass::eqNotifyMerge(TNode t1, TNode t2)
{
...
bool EqEngineManager::eqNotifyTriggerPredicate(TNode predicate, bool value)
{
